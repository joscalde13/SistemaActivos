<x-layouts.app :title="__('Nuevo Activo')">
    <h1 class="text-2xl font-bold text-gray-800 dark:text-gray-100 mb-6">Registrar Nuevo Activo</h1>

    <form action="{{ route('activos.store') }}" method="POST" class="bg-white dark:bg-gray-800 p-6 rounded-lg shadow space-y-4">
        @csrf
        <div>
        ...
        <div>
            <label for="fecha_alta" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Fecha de Alta</label>
