<x-layouts.app :title="__('Editar Activo')">
    <h1 class="text-2xl font-bold text-gray-800 mb-6">Editar Activo</h1>

    <form action="{{ route('activos.update', $activo->id) }}" method="POST" class="bg-white p-6 rounded-lg shadow space-y-4">
        @csrf
        @method('PUT')
